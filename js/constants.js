...
const MESSAGES = {
  ...
  DRAW: 'じゃんけんは あいこ！',
  PLAYER_DAMAGED: (damage) => `じゃんけんは タケシの かち！あなたは ダメージを うけた！`,
  // PLAYER_DAMAGED: (damage) => `じゃんけんは タケシの かち！あなたに ${damage} のダメージ！`,
  PC_DAMAGED: (damage) => `じゃんけんは あなたの かち！タケシに ダメージを あたえた！`,
  // PC_DAMAGED: (damage) => `じゃんけんは あなたの かち！タケシは ${damage} のダメージ！`,
  BOTH_DAMAGED: (playerDamage, pcDamage) => `じゃんけんは あいこ！`,
